...
export default async function BrowsePage() {
  ...
  // Property management companies share the same companies table (told
  // apart by org_type) but aren't cleaning businesses — excluded here so
  // the marketplace directory only ever lists contractors.
